...
<html>
	<head>
		...
		<script type="text/javascript" src="http://resources.tela-botanica.org/mustache.js/mustache.min.js"></script>
		<script type="text/javascript" src="<?= $fc->getRootUri() ?>/js/binette/binette.js"></script>
